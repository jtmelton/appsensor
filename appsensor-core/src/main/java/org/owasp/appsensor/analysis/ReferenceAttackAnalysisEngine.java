...
public class ReferenceAttackAnalysisEngine implements AnalysisEngine {
	...
	protected Response findAppropriateResponse(Attack attack) {
		...
		SearchCriteria criteria = new SearchCriteria().
				...
				setDetectionSystemIds(appSensorServer.getRelatedDetectionSystems(attack.getDetectionSystemId()));
	...
	protected Collection<Response> findPossibleResponses(DetectionPoint triggeringDetectionPoint) {
		...
		for (DetectionPoint configuredDetectionPoint : appSensorServer.getDetectionPoints()) {
