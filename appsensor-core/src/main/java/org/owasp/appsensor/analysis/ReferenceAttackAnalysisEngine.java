...
public class ReferenceAttackAnalysisEngine implements AnalysisEngine {
	...
	/**
	 * This method analyzes {@link org.owasp.appsensor.Attack} objects that are added 
	 * to the system (either via direct addition or generated by the event analysis
	 * engine), generates an appropriate {@link org.owasp.appsensor.Response} object, 
	 * and adds it to the configured {@link org.owasp.appsensor.storage.ResponseStore} 
	 * 
	 ...
	 * 			an {@link org.owasp.appsensor.Attack} object
	 */
	@Override
