...
public class InfluxDbEmitterTest {
	...
	private boolean isInitializedProperly() {
		return StringUtils.isNotBlank(environment.getProperty(InfluxDbEmitter.INFLUXDB_URL)) &&
				StringUtils.isNotBlank(environment.getProperty(InfluxDbEmitter.INFLUXDB_USERNAME)) &&
				StringUtils.isNotBlank(environment.getProperty(InfluxDbEmitter.INFLUXDB_PASSWORD));
