...
/**
 * Test prometheus metrics endpoint by extending the ReferenceStatisticalEventAnalysisEngineTest.
 * All of the same tests execute, but we're just verifying the prometheus work
 *
...
public class PrometheusEmitterTest {
    ...
    private boolean isInitializedProperly() {
        return StringUtils.isNotBlank(environment.getProperty(PrometheusEmitter.PROMETHEUS_PUSHGATEWAY_ADDRESS));
    }
