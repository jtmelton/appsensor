package org.owasp.appsensor.block.proxy.servlet;
 ...
 * </p>
 * 
 * This class was copied from https://github.com/mitre/HTTP-Proxy-Servlet
 * and very slightly modified to use the requestURI instead of the pathInfo 
 * when constructing proxied urls.
 *
...
public class ProxyServlet extends HttpServlet {
  ...
  protected String rewriteUrlFromRequest(HttpServletRequest servletRequest) {
    ...
    // modified from original to use request URI instead of path info
  ...
  protected String rewriteUrlFromResponse(HttpServletRequest servletRequest, String theUrl) {
    ...
    if (theUrl.startsWith(targetUri)) {
      ...
      if (requestURI != null) {
        assert curUrl.endsWith(requestURI);
        curUrl = curUrl.substring(0,curUrl.length()-requestURI.length());//take requestURI off
      }
