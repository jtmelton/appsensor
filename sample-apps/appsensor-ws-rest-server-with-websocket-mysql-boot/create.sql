...
create table detection_system (id integer not null auto_increment, detection_system_id varchar(255), ip_address blob, primary key (id))
...
create table ipaddress (id integer not null auto_increment, address varchar(255), geo_location blob, primary key (id))
...
create table user (id integer not null auto_increment, ip_address blob, username varchar(255), primary key (id))
